...
<head>
    ...
    <title>Medicare online pharmac</title>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3">
                    ...
                    <h4 class="fw-title">Heart</h4>
                        <h4 class="fw-title">Medicine</h4>
                ...
                <?php 
                        ...
                        if(isset($_GET['item'])){
                            ...
                            $sql = "SELECT * FROM iteam WHERE item_name='".$item_name."'"; 
                            $result = mysqli_query($connection, $sql);
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="product-pic-zoom">
                                                    <img class="product-big-img" img src="'.$row["data_path"] .'" alt="'.$row["item_name"].'">
                                                    <div class="zoom-icon">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="product-details">
                                                    ...
                                                    <div class="quantity">
                                                        ...
                                                        <a href="#" class="primary-btn pd-cart">ODER NOW</a>
                                                    </div>
                                                    <div class="pd-share">
                                                        <div class="pd-social">
