                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="unit_price" minlength="1" maxlength="10" name="txtEmpPhone" class="form-control" placeholder="Unit Pricee *" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="" required/>
                                        </div>
                                        <div class="form-group">
                                            <b><label for="username">The maximum quantity that the customer can choose  *</label></b>
                                            <input type="text" name="o_max_qut" minlength="1" maxlength="10" maxnumber="10" name="txtEmpPhone" class="form-control" placeholder="maximum quantity *" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" value="" required/>
                                        </div>
