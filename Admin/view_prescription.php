                        ...
                        <select class="form-select" aria-label="Default select example" id="my_select">
                           ...
                           // $itemListRow = mysqli_fetch_assoc($itemListQuery);
                            while($itemListRow=$itemListQuery->fetch_assoc()){
                               ...
                               echo'
                               <option name='.$itemListRow['o_max_qut'].' value='.$itemListRow['item_id'].' id='.$itemListRow['item_id'].'>'.$itemListRow["item_name"].'</option>
                               ';
                            }
                            ?>
                            </select>
                    </td>
                    <td class = "item_name"> <h5><input type="text" name="item_name" id="item_name" class="form-control" placeholder="Iteam Name *" readonly hidden/></h5> </td>
