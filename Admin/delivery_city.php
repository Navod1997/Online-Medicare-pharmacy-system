        ...
        <div class="container">
                    ...
                    <div class="col-md-9 register-right">
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h2 class>Add To delivery city</h2>
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <b><label for="username">City Name *</label></b>
                                    ...
                                    <div class="row" style="padding:30px;">
                                        <input type="submit" name="submit"  value="Add Category" style="background-color: #55acee" class="btn btn-primary">
                                    </div>
                                    </div>
                                ...
                                <?php
                                    ...
                                    if(isset($_POST["submit"])) {
                                        $city__name = $_POST["city_name"];

                                    $sql = "INSERT INTO delivary_citys (city_name)
                                    VALUES('".$city__name."')" ;

                                            if ($connection->query($sql) === TRUE) {
                                                echo '<script>swal("Add to new city success!", "Add to new city success.!", "success").then (function(){
            ...
            <table class="table table-striped table-responsive-md table-bordered my-5" style="width:100%" id="table">
                ...
                <?php
                    ...
                    $sql = "SELECT * FROM delivary_citys"; 
                    ...
                    echo    
                            ...
                            <tr>
                                <td>'.$row["city_name"] .'</td>
                                <td><a href="delete.php?id='.$id.'&req=citydelete"><i class="fa fa-trash" ></i></a> </td>
