                ...
                <div class="row page-titles">
                    ...
                    <h3 class="text-themecolor">Oders</h3>
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Completed Oders</li>
                        </ol>
                    </div>
                </div>
        <!-- End Page wrapper  -->
        ...
        <!-- order -->
                ...
                <div class="row">
                    ...
                    <div class="card-block">   
                            ...
                            <div class="card-block"> 
                                <h4 class="card-title">Completed Oders</h4>
                                <div class="table-responsive" style="height: 400px;overflow: scroll;">
                                    <table class="table table-striped table-responsive-md table-bordered my-5" style="width:100%" id="table">
                                        ...
                                        <?php
                                                ...
                                                $sql = "SELECT tracking.order_id,tracking.date,orders.status,orders.address,orders.city FROM `tracking`,`orders` WHERE tracking.order_id = orders.order_id  AND tracking.rider_id=".$_SESSION["driver_id"].";"; 
